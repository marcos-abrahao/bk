...
aTotais[04] := Transform(Val(oTotal:_ICMSTOT:_vST:TEXT),"@e 9,999,999,999,999.99") // DMAF
//aTotais[04] := Transform(Val(oTotal:_ICMSTOT:_vICMS:TEXT)+Val(oTotal:_ICMSTOT:_vFCPST:TEXT),"@e 9,999,999,999,999.99")
