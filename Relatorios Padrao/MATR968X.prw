...
#DEFINE STR0001 "Impressão RPS"
#DEFINE STR0002 "Impressão do Recibo Provisório de Serviços - RPS"
...
#DEFINE STR0015 "I.M.:"
#DEFINE STR0016 "Número/Série RPS"
#DEFINE STR0017 "Data Emissão"
#DEFINE STR0018 "Hora Emissão"
#DEFINE STR0019 "DADOS DO DESTINATÁRIO"
#DEFINE STR0020 "Nome/Razão Social:"
#DEFINE STR0021 "C.P.F./C.N.P.J.:"
#DEFINE STR0022 "Inscrição Municipal:"
...
#DEFINE STR0031 "Código do Serviço"
#DEFINE STR0032 "Total deduções (R$)"
#DEFINE STR0033 "Base de cálculo (R$)"
#DEFINE STR0034 "Alíquota (%)"
#DEFINE STR0035 "Valor do ISS (R$)"
#DEFINE STR0036 "INFORMAÇÕES SOBRE A NOTA FISCAL ELETRÔNICA"
#DEFINE STR0037 "Número"
#DEFINE STR0038 "Emissão"
#DEFINE STR0039 "Código Verificação"
#DEFINE STR0040 "Crédito IPTU"
#DEFINE STR0041 "OUTRAS INFORMAÇÕES"
#DEFINE STR0042 "STR0042"
#DEFINE STR0043 "Código do Serviço"
...
Else
	...
	While (cAliasSF3)->(!Eof())
		...
		For nX := 1 to nCopias
			...
			If lRecife
				oPrint:Say(1965+nLinS,250,Alltrim(STR0043),oFont10n) // "Código do Serviço"
				oPrint:Say(2005+nLinS,250,Alltrim(cCodAtiv),oFont10)
			ElseIf lBhorizonte
				oPrint:Say(1865+nLinS,250,Alltrim(STR0043),oFont10n) // "Código do Serviço"
			...
			ElseIf lPaulista .Or. lLondrina
				...
				oPrint:Say(2055+nLinS,250,Alltrim(STR0031),oFont10n) // "Código do Serviço"
				oPrint:Say(2100+nLinS,250,Alltrim(cCodServ),oFont10)
			Else
				oPrint:Say(1965+nLinS,250,Alltrim(STR0031),oFont10n) // "Código do Serviço"
			...
			If lRioJaneiro
				...
				oPrint:Say(2065+nLinS,250,Alltrim(STR0032),oFont09n) // "Total deduções (R$)"
				...
				oPrint:Say(2065+nLinS,1014,Alltrim(STR0033),oFont09n) // "Base de cálculo (R$)"
				oPrint:Say(2105+nLinS,1134,Transform((cAliasSF3)->F3_BASEICM,"@E 999,999,999.99"),oFont09)
				oPrint:Say(2065+nLinS,1484,Alltrim(STR0034),oFont09n) // "Alíquota (%)"
			...
			ElseIf lBhorizonte
				oPrint:Say(1950+nLinS,250,Alltrim("Valor dos serviços: "),oFont09n) // "Valor dos serviços"
				oPrint:Say(1950+nLinS,920,Transform(nVlContab,"@E 999,999,999.99"),oFont09)        
				oPrint:Say(1950+nLinS,1250,Alltrim("Valor dos serviços: "),oFont09n) // "Valor dos serviços"
				...
				oPrint:Say(2000+nLinS,1250,Alltrim("(-)Deduçoes: "),oFont09n) // "Deduções"
				...
				oPrint:Say(2100+nLinS,1250,Alltrim("(=)Base Cálc.: "),oFont09n) // "Base Cálc."
				...
				oPrint:Say(2150+nLinS,1250,Alltrim("Alíquota: "),oFont09n) // "Alíquota"
				...
				oPrint:Say(2330+nLinS,nColIni,PadC(Alltrim(STR0036),75),oFont10n) // "INFORMAÇÕES SOBRE A NOTA FISCAL ELETRÔNICA"
				...
				oPrint:Say(2400+nLinS,250,Alltrim(STR0037),oFont09n) // "Número"
				oPrint:Say(2440+nLinS,250,Padl(StrZero(Year((cAliasSF3)->F3_EMISSAO),4)+"/"+(cAliasSF3)->F3_NFELETR,nTamNfelet),oFont09)
				oPrint:Say(2400+nLinS,737,Alltrim(STR0038),oFont09n) // "Emissão"
				oPrint:Say(2440+nLinS,757,Padl(Transform(dToC((cAliasSF3)->F3_EMINFE),"@d"),14),oFont09)
				oPrint:Say(2400+nLinS,1094,Alltrim(STR0039),oFont09n) // "Código Verificação"
				oPrint:Say(2440+nLinS,1144,Padl((cAliasSF3)->F3_CODNFE,32),oFont09)
				oPrint:Say(2400+nLinS,1711,Alltrim(STR0040),oFont09n) // "Crédito IPTU"
			...
			ElseIf lPaulista .Or. lLondrina
				...
				oPrint:Say(2160+nLinS,250,Alltrim(STR0032),oFont10n) // "Total deduções (R$)"
				oPrint:Say(2200+nLinS,280,Transform(nValDed,"@E 999,999,999.99"),oFont10)	
				oPrint:Say(2160+nLinS,600,Alltrim(STR0033),oFont10n) // "Base de cálculo (R$)"
				oPrint:Say(2200+nLinS,670,Transform((cAliasSF3)->F3_BASEICM,"@E 999,999,999.99"),oFont10)
				oPrint:Say(2160+nLinS,1000,Alltrim(STR0034),oFont10n) // "Alíquota (%)"
				...
				oPrint:Say(2160+nLinS,1800,Alltrim(STR0051),oFont10n) // "Crédito (R$)"
				...
				oPrint:Say(2260+nLinS,250,Alltrim(STR0052),oFont10n) //"Municipio da Prestação do Serviço"
				oPrint:Say(2300+nLinS,250,cMunPreSer,oFont10)
				oPrint:Say(2260+nLinS,940,Alltrim(STR0053),oFont10n) //"Número da Inscrição da Obra"
			...
			Else
				...
				oPrint:Say(2065+nLinS,250,Alltrim(STR0032),oFont10n) // "Total deduções (R$)"
				oPrint:Say(2105+nLinS,370,Transform(nValDed,"@E 999,999,999.99"),oFont10)
				oPrint:Say(2065+nLinS,737,Alltrim(STR0033),oFont10n) // "Base de cálculo (R$)"
				...
				oPrint:Say(2065+nLinS,1224,Alltrim(STR0034),oFont10n) // "Alíquota (%)"
			...
			If !(lBhorizonte .Or. lPaulista .Or. lLondrina)
				oPrint:Say(2180+nLinS,nCentro/2-len(STR0036),STR0036,oFont12n) // "INFORMAÇÕES SOBRE A NOTA FISCAL ELETRÔNICA"
				...
				oPrint:Say(2265+nLinS,250,Alltrim(STR0037),oFont10n) // "Número"
				oPrint:Say(2305+nLinS,250,Padl(StrZero(Year((cAliasSF3)->F3_EMISSAO),4)+"/"+(cAliasSF3)->F3_NFELETR,nTamNfelet),oFont10)
				oPrint:Say(2265+nLinS,737,Alltrim(STR0038),oFont10n) // "Emissão"
				oPrint:Say(2305+nLinS,757,Padl(Transform(dToC((cAliasSF3)->F3_EMINFE),"@d"),14),oFont10)
				oPrint:Say(2265+nLinS,1094,Alltrim(STR0039),oFont10n) // "Código Verificação"
				oPrint:Say(2305+nLinS,1144,Padl((cAliasSF3)->F3_CODNFE,32),oFont10)
				oPrint:Say(2265+nLinS,1711,Alltrim(STR0040),oFont10n) // "Crédito IPTU"
			...
			If !lBhorizonte
				oPrint:Say(2363+nLinS,nCentro/2-len(STR0041),STR0041,oFont12n) // "OUTRAS INFORMAÇÕES"
				nLinha	:= 2423+nLinS
				For nY := 1 to Len(aPrintObs)
					If nY > 11
						Exit
