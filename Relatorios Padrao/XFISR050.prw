...
cQuery := " SELECT SE2.E2_NUM,SE2.E2_PREFIXO,SE2.E2_TIPO,SE2.E2_FORNECE,SE2.E2_EMISSAO,SE2.E2_VENCTO,SE2.E2_VENCREA,SE2.E2_VALOR,F1_EMISSAO,F1_VALBRUT,F1_DOC,F1_SERIE,F1_FORNECE,F1_LOJA,A2_NOME,A2_CGC,A2_COD,SE2.E2_NATUREZ,A2_LOJA, "  
cQuery += " CASE  WHEN SE2.E2_TIPO = 'INS' THEN ROUND((SUM(FT_VALINS) * 100) / SUM(FT_BASEINS),2)"
...
If !Empty(cFitro)
	cQuery += " AND " + cFitro
EndIf
cQuery += " GROUP BY SE2.E2_NUM,SE2.E2_PREFIXO,SE2.E2_TIPO,SE2.E2_FORNECE,SE2.E2_EMISSAO,SE2.E2_VENCTO,SE2.E2_VENCREA,SE2.E2_VALOR,F1_EMISSAO,F1_VALBRUT,F1_DOC,F1_SERIE,F1_FORNECE,F1_LOJA,A2_NOME,A2_CGC,A2_COD,SE2.E2_NATUREZ,A2_LOJA"
If MV_PAR06  == 1
