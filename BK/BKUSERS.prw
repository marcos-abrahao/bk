...
// É do grupo Master Libera Docs
User Function IsMLibDc(cId)
Return u_InGrupo(cId,u_GrpMLibDc())
...
// Email para Grupo do (Barbara,Jose Amauri,Bianca,Wendell)
