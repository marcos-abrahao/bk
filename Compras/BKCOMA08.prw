...
u_MsgLog("BKCOMA08","Acessado Doc: "+TRIM(SF1->F1_DOC+SF1->F1_SERIE+SF1->F1_FORNECE+SF1->F1_LOJA+": "+SF1->F1_ESPECIE+"-"+SF1->F1_CHVNFE))
...
DEFINE MSDIALOG oDlg TITLE cTitulo2 FROM 000,000 TO 240,500 PIXEL
...
If ( lOk )
    ...
    u_MsgLog("BKCOMA08","Alterado Doc: "+TRIM(SF1->F1_DOC+SF1->F1_SERIE+SF1->F1_FORNECE+SF1->F1_LOJA+": "+SF1->F1_ESPECIE+"-"+SF1->F1_CHVNFE))
