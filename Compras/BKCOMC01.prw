...
ฑฑบFuncao    ณBKCOMC01  บAutor  ณ Marcos B. Abrahใo  บ Data ณ 29/09/2009  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Consulta Documento de Entrada e Pre-Nota                   บฑฑ
...
//Ajuste nova rotina a antiga nใo funciona na nova lib MDI
	...
	//cSuper := aUser[1,11]
	// Se o usuario pertence ao grupo Administradores ou Master Financeiro ou Master Diretoria: nใo filtrar
...
/*
If Empty(aSd1)
	MsgStop("Nenhum item encontrado", "Aten็ใo")
	RestArea(aAreaIni)
	Return
EndIf
*/
...
//@ 000, 000 LISTBOX oListID FIELDS HEADER "Filial","Doc","Serie","Item","Produto","Total R$","Hist๓rico" SIZE aSize[6],aSize[5] OF oPanelLeft PIXEL 
...
AADD(aRegistros,{cPerg,"02","Pesquisar hist๓rico"      ,"Historico"      ,"Historico"      ,"mv_ch2","C",20,0,0,"G","","mv_par02","","","","","","","","","","","","","","","","","","","","","","","","","","S","",""})
