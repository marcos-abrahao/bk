...
Do while !eof() .and. SX3->X3_ARQUIVO == "SA2"
    IF SX3->X3_CONTEXT <> "V" .AND. X3USO(SX3->X3_USADO)
		...
		ELSEIF Alltrim(SX3->X3_CAMPO) $ "A2_REPR_AG/A2_CBO/A2_CIVIL/A2_GRPDEP/A2_FRETISS/A2_INSCMU/A2_CONTPRE/A2_CPFIRP/A2_RETISI/A2_ISICM/A2_UFFIC/A2_TPREG/A2_SUBCON"
