...
If _lCanc	
	cAssunto:= "Estorno de classificação de Nota Fiscal liberada nº.:"+SF1->F1_DOC+" Série: "+SF1->F1_SERIE+" - Fornecedor: " +SA2->A2_COD+"-"+SA2->A2_LOJA+" - "+SA2->A2_NOME+" - "+FWEmpName(cEmpAnt)
...
Else
	...
	cAssunto:= "Solicitação de Liberação de Nota Fiscal nº.:"+SF1->F1_DOC+" Série:"+SF1->F1_SERIE+"    Fornecedor: " +SA2->A2_COD+"-"+SA2->A2_LOJA+" - "+SA2->A2_NOME+" - "+FWEmpName(cEmpAnt)
