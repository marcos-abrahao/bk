...
Local cEmLibPed := "ricardo.monaco@bkconsultoria.com.br;caio.silva@bkconsultoria.com.br;aprendiz.almoxarifado@bkconsultoria.com.br;joao.vitor@bkconsultoria.com.br;"
...
IF ALLTRIM(cTipoDoc) <> "PC"
	...
	cEmail += cEmUSER
	u_xxLog("MT094END.TXT","1-"+cEmail,.F.,"TESTE")        
	IF nOpcao = 5  //3
		cAssunto:= "Bloqueada"
	ELSE
		cAssunto:= "Liberada"
...
IF nOpcao == 4 //Era 2
	IF cTPLIBER == "P"
        ...
        cEmail += cEmLibPed
       	...
       	u_xxLog("MT094END.TXT","3-"+cEmail,.T.,"")        
    ...
    ELSE
  		FOR IT_ := 1 TO LEN(aSCR)
			...
			ENDIF
		NEXT
		u_xxLog("MT094END.TXT","4-"+cEmail,.T.,"")        
...
ELSEIF nOpcao == 5 // era3
	...
	ELSE
		...
		NEXT
    ENDIF
	u_xxLog("MT094END.TXT","5-"+cEmail,.T.,"")        
...
u_xxLog("MT094END.TXT","6-"+cEmail,.T.,"")        
...
u_xxLog("MT094END.TXT","7-"+cEmail,.T.,"")        
