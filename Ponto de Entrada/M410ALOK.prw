...
If !Empty(SC5->C5_NOTA) .and. ALTERA
	MsgBox("Nota Fiscal jแ gerada, pedido nใo pode ser Alterado!","M410ALOK","ALERT")
	_lRet := .F.
Else
	If !Empty(SC5->C5_MDCONTR) .and. ALTERA
		MsgBox("Pedido de Origem na Gestใo de Contratos nao pode ser Alterado no Faturamento!","M410ALOK","ALERT")
		If __cUserId <> "000000"
			_lRet := .F.
		Else
			MsgBox("Pedido de Origem na Gestใo de Contratos - Altera็ใo permitida para o Adm!","M410ALOK","ALERT")
		Endif
	Endif
Endif
