...
cQuery += "    F2_DOC,F2_CLIENTE,F2_LOJA,F2_EMISSAO,F2_VALFAT,F2_VALIRRF,F2_VALINSS,F2_VALPIS,F2_VALCOFI,F2_VALCSLL,F2_RECISS,F2_VALISS,F2_VLCPM,F2_XXVFUMD, "+ CRLF
