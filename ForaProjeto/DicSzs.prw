...
/*/
//--------------------------------------------------------------------
User Function DicSzs( cEmpAmb, cFilAmb )
...
aAdd( aSX2, { ;
	...
	'Facilitador Doc Entrada'												, ; //X2_NOME
	'Facilitador Doc Entrada'												, ; //X2_NOMESPA
	'Facilitador Doc Entrada'												, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ '1=Nota Gerada;2=Nota nao gerada'										, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	...
	{ 'Razao Social'														, .T. }, ; //X3_DESCRIC
	{ 'Razao Social'														, .T. }, ; //X3_DESCSPA
	{ 'Razao Social'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'Iif(!Inclui,Posicione("SA2",1,xFilial("SA2")+SZS->ZS_FORNEC+SZS->ZS_LOJA,"A2_NOME"),"")', .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'Posicione("SA2",1,xFilial("SA2")+SZS->ZS_FORNEC+SZS->ZS_LOJA,"A2_NOME")'	, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	...
	{ 'Cond. Pagto'															, .T. }, ; //X3_DESCRIC
	{ 'Cond. Pagto'															, .T. }, ; //X3_DESCSPA
	{ 'Cond. Pagto'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Emissao'																, .T. }, ; //X3_TITSPA
	{ 'Emissao'																, .T. }, ; //X3_TITENG
	{ 'Emissao'																, .T. }, ; //X3_DESCRIC
	{ 'Emissao'																, .T. }, ; //X3_DESCSPA
	{ 'Emissao'																, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Especie'																, .T. }, ; //X3_TITSPA
	{ 'Especie'																, .T. }, ; //X3_TITENG
	{ 'Especie'																, .T. }, ; //X3_DESCRIC
	{ 'Especie'																, .T. }, ; //X3_DESCSPA
	{ 'Especie'																, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZS'																	, .T. }, ; //X3_ARQUIVO
	{ '12'																	, .T. }, ; //X3_ORDEM
	{ 'ZS_XXPVPGT'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Prev.Pgto'															, .T. }, ; //X3_TITULO
	{ 'Prev.Pgto'															, .T. }, ; //X3_TITSPA
	{ 'Prev.Pgto'															, .T. }, ; //X3_TITENG
	{ 'Prev.Pgto'															, .T. }, ; //X3_DESCRIC
	{ 'Prev.Pgto'															, .T. }, ; //X3_DESCSPA
	{ 'Prev.Pgto'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Tipo Pgto'															, .T. }, ; //X3_DESCRIC
	{ 'Tipo Pgto'															, .T. }, ; //X3_DESCSPA
	{ 'Tipo Pgto'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZS'																	, .T. }, ; //X3_ARQUIVO
	{ '17'																	, .T. }, ; //X3_ORDEM
	{ 'ZS_XNUMPA'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Numero PA'															, .T. }, ; //X3_TITULO
	{ 'Numero PA'															, .T. }, ; //X3_TITSPA
	{ 'Numero PA'															, .T. }, ; //X3_TITENG
	{ 'Numero PA'															, .T. }, ; //X3_DESCRIC
	{ 'Numero PA'															, .T. }, ; //X3_DESCSPA
	{ 'Numero PA'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZS'																	, .T. }, ; //X3_ARQUIVO
	{ '18'																	, .T. }, ; //X3_ORDEM
	{ 'ZS_XXJSPGT'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 30																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Just Pgt.'															, .T. }, ; //X3_TITULO
	{ 'Just Pgt.'															, .T. }, ; //X3_TITSPA
	{ 'Just Pgt.'															, .T. }, ; //X3_TITENG
	{ 'Justif. Pagamento 48h'												, .T. }, ; //X3_DESCRIC
	{ 'Justif. Pagamento 48h'												, .T. }, ; //X3_DESCSPA
	{ 'Justif. Pagamento 48h'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'Iif(!Inclui,Posicione("SB1",1,xFilial("SB1")+SZS->ZS_COD,"B1_DESC"),"")'	, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'Posicione("SB1",1,xFilial("SB1")+SZS->ZS_COD,"B1_DESC")'				, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	...
	{ 'CC'																	, .T. }, ; //X3_TITSPA
	{ 'CC'																	, .T. }, ; //X3_TITENG
	{ 'Centro de Custos'													, .T. }, ; //X3_DESCRIC
	{ 'Centro de Custos'													, .T. }, ; //X3_DESCSPA
	{ 'Centro de Custos'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ '"000000001"'															, .T. }, ; //X3_RELACAO
	{ 'CTT'																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	{ 'Descricao Centro de Custo'											, .T. }, ; //X3_DESCRIC
	{ 'Descricao Centro de Custo'											, .T. }, ; //X3_DESCSPA
	{ 'Descricao Centro de Custo'											, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'Iif(!Inclui,Posicione("CTT",1,xFilial("CTT")+SZS->ZS_CC,"CTT_DESC01"),"")', .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'Posicione("CTT",1,xFilial("CTT")+SZS->ZS_CC,"CTT_DESC01")'			, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	...
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Ult Geracao'															, .T. }, ; //X3_TITULO
	{ 'Ult Geracao'															, .T. }, ; //X3_TITSPA
	{ 'Ult Geracao'															, .T. }, ; //X3_TITENG
	{ 'Ult Geracao'															, .T. }, ; //X3_DESCRIC
	{ 'Ult Geracao'															, .T. }, ; //X3_DESCSPA
	{ 'Ult Geracao'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Erro'																, .T. }, ; //X3_TITSPA
	{ 'Erro'																, .T. }, ; //X3_TITENG
	{ 'Ultimo erro'															, .T. }, ; //X3_DESCRIC
	{ 'Ultimo erro'															, .T. }, ; //X3_DESCSPA
	{ 'Ultimo erro'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'SZS'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZS_FILIAL+ZS_FORNEC+ZS_LOJA'											, ; //CHAVE
