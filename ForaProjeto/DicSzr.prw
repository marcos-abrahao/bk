...
/*/
//--------------------------------------------------------------------
User Function DicSzr( cEmpAmb, cFilAmb )
...
aAdd( aSX2, { ;
	'SZR'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'SZR010'																, ; //+cempr X2_ARQUIVO
	'Motivos Glosas e Bonificacoes'											, ; //X2_NOME
	'Motivos Glosas e Bonificacoes'											, ; //X2_NOMESPA
	'Motivos Glosas e Bonificacoes'											, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	{ 'CNR'																	, .T. }, ; //X3_ARQUIVO
	{ '04'																	, .T. }, ; //X3_ORDEM
	{ 'CNR_XTPJUS'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tipo Justif.'														, .T. }, ; //X3_TITULO
	{ 'Tipo Justif.'														, .T. }, ; //X3_TITSPA
	{ 'Tipo Justif.'														, .T. }, ; //X3_TITENG
	{ 'Tipo Justificativa'													, .T. }, ; //X3_DESCRIC
	{ 'Tipo Justificativa'													, .T. }, ; //X3_DESCSPA
	{ 'Tipo Justificativa'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ 'ExistCpo("SZR")'														, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tipo Glo/Bon'														, .T. }, ; //X3_TITULO
	{ 'Tipo Glo/Bon'														, .T. }, ; //X3_TITSPA
	{ 'Tipo Glo/Bon'														, .T. }, ; //X3_TITENG
	{ 'Tipo Glosa ou Bonificacao'											, .T. }, ; //X3_DESCRIC
	{ 'Tipo Glosa ou Bonificacao'											, .T. }, ; //X3_DESCSPA
	{ 'Tipo Glosa ou Bonificacao'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ 'ExistChav("SZR")'													, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSIX, { ;
	'SZR'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZR_FILIAL+ZR_TIPO'														, ; //CHAVE
	'Tipo Glo/Bon'															, ; //DESCRICAO
	'Tipo Glo/Bon'															, ; //DESCSPA
	'Tipo Glo/Bon'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	'ZRTIPO'																, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Comunicacoa Bancaria'													, ; //XB_DESCRI
	'Comunicacoa Bancaria'													, ; //XB_DESCSPA
	'Comunicacoa Bancaria'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SEE'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'05'																	, ; //XB_COLUNA
	'Sit.Trib.PIS'															, ; //XB_DESCRI
	'Sit.Trib.PIS'															, ; //XB_DESCSPA
	'PIS Tax St.'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'F4_CSTPIS'																} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'06'																	, ; //XB_COLUNA
	'Cod.BC Cred.'															, ; //XB_DESCRI
	'Cod.BC Cred.'															, ; //XB_DESCSPA
	'Cred BC Code'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'F4_CODBCC'																} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	''																		, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SubStr(SM0->M0_CODFIL,1,0) == FwCodEMP()'								} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Posicao Desvio'														, ; //XB_DESCRI
	'Posicao Desvio'														, ; //XB_DESCSPA
	'Posicao Desvio'														, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SX5'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Tipos Glosas/Bonif'													, ; //XB_DESCRI
	'Tipos Glosas/Bonif'													, ; //XB_DESCSPA
	'Tipos Glosas/Bonif'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SZR'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'01'																	, ; //XB_COLUNA
	'Tipo Glo/bon'															, ; //XB_DESCRI
	'Tipo Glo/bon'															, ; //XB_DESCSPA
	'Tipo Glo/bon'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZRTIPO'																} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Ind. Comercialização'													, ; //XB_DESCRI
	'Ind. Comercializació'													, ; //XB_DESCSPA
	'Commerc Ind'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'T1T'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'01'																	, ; //XB_COLUNA
	'Dicionario de Tabela'													, ; //XB_DESCRI
	'Dicionario de Tabela'													, ; //XB_DESCSPA
	'Dicionario de Tabela'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ATF3TABLE()'															} ) //XB_CONTEM
