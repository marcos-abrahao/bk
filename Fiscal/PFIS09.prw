...
ฑฑบPrograma  ณ PFIS09   บ Autor ณ Adilson do Prado          Data ณ29/01/13บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Corre็ao Calculo Pis Cofins conforme TES-Mr / Proeletronic บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ  Mr / Proeletronic                                         บฑฑ
...
Local titulo         := "Retifica็ใo calculo PIS COFINS conforme TES"
Local aDbf := {},cArqTmp
LOCAL cPerg        := "PFIS09"
...
IF EMPTY(dDataFinal) .OR.  EMPTY(dDataInicio)
	MSGSTOP("Informe a data inํcio e final")                
	Return Nil
...
titulo   := titulo+" - Perํodo:"+DTOC(dDataInicio)+" at้ "+DTOC(dDataFinal)
...
Private cCadastro	:= "Retifica็ใo calculo PIS COFINS conforme TES"
Private aRotina		:= {}
Private aIndexSz  	:= {}
...
cQuery+= "B1_ORIGEM+F4_SITTRIB AS F4_SITTRIB,F4_PISCOF,F4_CSTPIS,F4_CSTCOF,F4_PISBRUT,F4_COFBRUT,F4_PISCRED,FT_TIPOMOV" 
...
Do While (ALIAS_TMP)->(!eof())
	...
	IF  (ALIAS_TMP)->FT_TIPOMOV == 'E'
		...
		// Verificar se estแ considerando o parametro MV_FRTBASE - Frete e desp na base
...
IF __CUSERID <> '000000'
	MSGSTOP("Usuแrio  Nใo  Autorizado")
	Return Nil
Endif
...
IF nOPC_ == 1
	IF !MsgBox("Esta rotina corrigirแ os campos SITTIB,CSTPI,CSTCOFINS,ALIQPIS,ALIQCOF,BASEPIS,BASECOF,VALPIS,VALCOF nas Tabelas do Livro Fiscal. Deseja realmente confinuar?","Aten็ใo","YESNO")
		Return nil
	ENDIF
ELSEIF nOPC_ == 2
	IF !MsgBox("Esta rotina corrigirแ o codigo nos campos SITTIB,CSTPI,CSTCOFINS nas Tabelas do Livro Fiscal. Deseja realmente confinuar?","Aten็ใo","YESNO")
		Return nil
	ENDIF
ELSEIF nOPC_ == 3
	IF !MsgBox("Esta rotina corrigirแ o calculo nos campos ALIQPIS,ALIQCOF,BASEPIS,BASECOF,VALPIS,VALCOF nas Tabelas do Livro Fiscal. Deseja realmente confinuar?","Aten็ใo","YESNO")
		Return nil
	ENDIF
ELSE
	Return nil
...
If nHandle > 0
   ...
   fClose(nHandle)
   IF nOP == 1   
		MsgInfo("O arquivo "+cArqTmp+" serแ aberto no MsExcel","PFIS09")
   ...
   ENDIF
Else
   MsgAlert("Falha na cria็ใo do arquivo "+cArqTmp,"PFIS09")
Endif
...
ELSE
	AADD(aRegistros,{cPerg,"01","Data Inํcio ?" ,"Data Inํcio ?" ,"Data Inํcio ?" ,"mv_ch1","D",08,0,0,"G","","mv_par01","","","","","","","","","","","","","","","","","","","","","","","","","","S","",""})
